...
export default function MobileAuth() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col items-center justify-center p-4 bg-white bg-cover bg-center bg-no-repeat"
      style={{
    ...
    >
      ...
      <div className="w-full flex items-center justify-center p-1">
        <div className="w-full max-w-md space-y-8 bg-white/60 p-8 md:p-12 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-white">
          ...
          <div
            className={`${error ? "bg-rose-50" : "bg-transparent"} text-rose-600 p-2 h-12 rounded-xl flex items-center gap-3 text-sm font-bold ${error && "border border-rose-100"} animate-shake`}
          >
            {error && (
              <>
                <AlertCircle size={18} />
